...
import { Clock, Users, Star, Filter, Grid, List, Brain, Code, Cloud, Database, BookOpen, TrendingUp, Cpu } from 'lucide-react';

const AIMLCoursePage = () => {
    ...
    const courses = [
        ...
        },
        {
            ...
            description: 'A practical, interview-focused DSA course that builds solid algorithmic thinking and problem solving using Python and C++ (optionally). Students will learn common data structures, complexity analysis, and patterns needed to pass technical interviews and write efficient production code.',
            category: 'Computer Science/Programming',
            duration: '10 weeks',
            level: 'Intermediate',
            price: '₹15,500',
            rating: 4.8, // Assuming a high rating
            students: 215, // Sample student count
            color: 'from-purple-500 to-purple-600', // Different color theme
            icon: <Code className="w-6 h-6" />, // Assuming you have a Code icon
            tags: ['Interview Prep', 'Essential'],
            technologies: ['Python', 'C++', 'Algorithms', 'Data Structures', 'Big O'],
        ...
        },
        {
            ...
            technologies: ['SQL', 'PostgreSQL', 'MySQL', 'SQLite', 'Database Design', 'Query Optimization'],
            image: 'https://images.pexels.com/photos/1181677/pexels-photo-1181677.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&fit=crop'
        },
        {
            id: 18,
            slug: 'data-visualization-power-bi-tableau',
            title: 'Data Visualization with Power BI & Tableau (Public)',
            description: 'Create compelling data visualizations and interactive dashboards using industry-standard tools. Transform raw data into actionable business insights.',
            category: 'AI/ML/Data Science/Gen AI',
            duration: '6 weeks',
            level: 'Starter',
            price: '₹7,000',
            ...
            icon: <TrendingUp className="w-6 h-6" />,
            tags: ['Popular', 'Business Ready'],
            technologies: ['Power BI', 'Tableau Public', 'DAX', 'Data Modeling', 'Dashboard Design', 'KPI Development'],
        ...
        },
        {
            ...
            description: 'Introduction to machine learning algorithms, model training, and evaluation techniques. Perfect foundation for aspiring ML practitioners.',
            category: 'AI/ML/Data Science/Gen AI',
            duration: '6 weeks',
            level: 'Starter',
            price: '₹7,000',
        ...
        {
            id: 20,
            slug: 'cloud-fundamentals-data-ai',
            title: 'Cloud Fundamentals for Data & AI',
            description: 'Learn cloud computing essentials for data science and AI workloads. Master AWS, Azure, and GCP services for scalable data solutions.',
            category: 'AI/ML/Data Science/Gen AI',
            duration: '6 weeks',
            level: 'Starter',
            price: '₹7,000',
            ...
            icon: <Cloud className="w-6 h-6" />,
            tags: ['Cloud', 'Future Ready'],
            technologies: ['AWS', 'Azure', 'GCP', 'S3', 'EC2', 'Lambda', 'Docker', 'Kubernetes'],
            image: 'https://images.pexels.com/photos/325229/pexels-photo-325229.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&fit=crop'
        },
        {
            id: 21,
            slug: 'apis-automation-python',
            title: 'APIs & Automation with Python',
            description: 'Build and consume APIs, automate repetitive tasks, and create efficient workflows. Essential skills for modern data professionals.',
            category: 'AI/ML/Data Science/Gen AI',
            duration: '6 weeks',
            level: 'Starter',
            price: '₹7,000',
            ...
            tags: ['Automation', 'Practical'],
            technologies: ['Python', 'FastAPI', 'Flask', 'REST APIs', 'Selenium', 'BeautifulSoup', 'Requests'],
    ...
    const CourseCard = ({ course, isListView }: { course: Course; isListView: boolean }) => (
        <div className={`bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 group overflow-hidden ${isListView ? 'flex' : ''}`}>
          ...
          View Details
                ...
                <Link
                    to={`/${course.slug}`}
                    className="w-full text-center bg-gray-900 text-white px-6 py-3 rounded-full font-semibold hover:bg-gray-800 transition-colors group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 block"
                >
                    View Details
                </Link>
            </div>
